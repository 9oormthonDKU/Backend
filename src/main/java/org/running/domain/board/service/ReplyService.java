...
public class ReplyService {
    ...
    @Transactional
    public String deleteReply(Long replyNumber) {
        Optional<Reply> replyOptional = replyRepository.findById(replyNumber);
        Reply reply = replyOptional.orElseThrow(() -> new RuntimeException("댓글이 존재하지 않습니다."));
